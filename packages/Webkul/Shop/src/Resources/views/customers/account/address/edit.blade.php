                        ...
                        <form method="post" action="{{ route('customer.address.edit', $address->id) }}" @submit.prevent="onSubmit">
                            ...
                            <div class="account-table-content">
                                ...
                                <div class="form-group" :class="[errors.has('city') ? 'has-error' : '']">
                                    ...
                                    <input type="text" class="form-control" name="city" v-validate="'required|alpha_spaces'" value="{{ $address->city }}" data-vv-as="&quot;{{ __('shop::app.customer.account.address.create.city') }}&quot;">
                                ...
                                <div class="form-group" :class="[errors.has('postcode') ? 'has-error' : '']">
                                    ...
                                    <input type="text" class="form-control" name="postcode" v-validate="'required'" value="{{ $address->postcode }}" data-vv-as="&quot;{{ __('shop::app.customer.account.address.create.postcode') }}&quot;">
                                ...
                                <div class="form-group" :class="[errors.has('phone') ? 'has-error' : '']">
                                    ...
                                    <input type="text" class="form-control" name="phone" v-validate="'required'" value="{{ $address->phone }}" data-vv-as="&quot;{{ __('shop::app.customer.account.address.create.phone') }}&quot;">

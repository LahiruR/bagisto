            ...
            <div class="auth-content">
                    ...
                    <form method="POST" action="{{ route('customer.session.create') }}" @submit.prevent="onSubmit">
                        ...
                        <div class="login-form">
                            <h4 class="login-text">{{ __('shop::app.customer.login-form.title') }}</h4>
                            ...
                            <div class="control-group form-group" :class="[errors.has('password') ? 'has-error' : '']">
                                ...
                                <input type="password" class="control form-control" name="password" v-validate="'required'" value="{{ old('password') }}" data-vv-as="&quot;{{ __('shop::app.customer.login-form.password') }}&quot;">

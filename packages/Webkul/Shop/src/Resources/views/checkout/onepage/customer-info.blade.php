<form data-vv-scope="address-form">
    ...
    <div class="form-container" v-if="!this.new_billing_address">
        ...
        <div class="address-holder">
            ...
            <div class="form-group" :class="[errors.has('address-form.billing[address_id]') ? 'has-error' : '']">
    ...
    <div class="form-container" v-if="this.new_billing_address">
        ...
        <div class="form-group" :class="[errors.has('address-form.billing[country]') ? 'has-error' : '']">
    ...
    @if ($cart->haveStockableItems())
        <div class="form-container" v-if="!address.billing.use_for_shipping && !this.new_shipping_address">
            ...
            <div class="address-holder">
                ...
                <div class="form-group" :class="[errors.has('address-form.shipping[address_id]') ? 'has-error' : '']">
        ...
        <div class="form-container" v-if="!address.billing.use_for_shipping && this.new_shipping_address">
            ...
            <div class="form-group" :class="[errors.has('address-form.shipping[first_name]') ? 'has-error' : '']">
            ...
            <div class="form-group" :class="[errors.has('address-form.shipping[last_name]') ? 'has-error' : '']">
            ...
            <div class="form-group" :class="[errors.has('address-form.shipping[email]') ? 'has-error' : '']">
            ...
            <div class="form-group" :class="[errors.has('address-form.shipping[address1][]') ? 'has-error' : '']">
            ...
            <div class="form-group" :class="[errors.has('address-form.shipping[city]') ? 'has-error' : '']">
            ...
            <div class="form-group" :class="[errors.has('address-form.shipping[state]') ? 'has-error' : '']">
            ...
            <div class="form-group" :class="[errors.has('address-form.shipping[postcode]') ? 'has-error' : '']">
            ...
            <div class="form-group" :class="[errors.has('address-form.shipping[country]') ? 'has-error' : '']">
            ...
            <div class="form-group" :class="[errors.has('address-form.shipping[phone]') ? 'has-error' : '']">
